...
public class ComposePage extends JFrame implements ActionListener
{
    ...
    private static class JPEGImageEncoder {

        public JPEGImageEncoder() {
        }

        private JPEGEncodeParam getDefaultJPEGEncodeParam(BufferedImage thumbImage) {
            throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
        }

        private void setJPEGEncodeParam(JPEGEncodeParam param) {
            throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
        }

        private void encode(BufferedImage thumbImage) {
            throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
        }
    }
    ...
    private static class JPEGEncodeParam {
        ...
        private void setQuality(float f, boolean b) {
            throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
        }
    }
}
